$(function(){
	...
	var characterList = {
		a: {
			...
			detail: "あなたは完璧を求めて、何事にも向上心を持ち正確に仕事をこなしていく【完璧主義】タイプです。<br/><br/>" +
				"その真面目さと正確に実行をする点からどのビジネスモデルのノウハウを実践しても結果を出すことができるでしょう。<br/><br/>" +
				"仕事においては依頼されたことを最後まで実践をする責任感があるので、周りから信頼はされますが、１度にたくさん頼まれると" +
				"どれも終わらなくなるという、融通が利かない点もあります。<br/><br/>" +
				"ただネットビジネスでは１度に多くのことをやるよりも、１つのことに集中して作業を行った方が最短で結果が出ますし、絞った方がスキルも磨かれ、" +
				"より大きな結果を残すことが出来ます。<br/><br/>" +
				"あなたは常に高みを目指して、毎日のようにコツコツ作業ができるので、ネットビジネスにはとても向いているでしょう。<br/><br/>" +
				"しかし、自分が業務に対し完璧を求めるあまり、他人にも完璧を求めてしまうので、" +
				"他人に依頼をする時に「ちゃんとできるかな」と強い不信感を抱いてしまうこともあるでしょう。<br/><br/>" +
